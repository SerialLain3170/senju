...
#from model_stylegan import Encoder, Decoder
#from model_stylegan import Discriminator, CooccurenceDiscriminator
from model_stylegan2 import Encoder, Decoder
from model_stylegan2 import Discriminator, CooccurenceDiscriminator
